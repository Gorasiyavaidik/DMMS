...
const RoughToSell = (data) => {
    ...
    const handleChangeState = () => {
        navigate(`/inventory/changestate/${serialNo}`, {
            state: { state: "RoughToSell" },
        });
    };
    return (
        <div className="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
            ...
            <Modal open={open} onClose={() => setOpen(false)}>
                <div className="text-center w-full">
                    <div className="mx-auto my-4 w-48"></div>
                    <div className="flex gap-4">
                        {/* <button className="inline-flex items-center justify-center rounded-md border border-primary py-1 px-4 mx-1 text-center font-medium text-white bg-primary hover:bg-opacity-90 lg:px-8 xl:px-8">
                            Edit
                        </button> */}
