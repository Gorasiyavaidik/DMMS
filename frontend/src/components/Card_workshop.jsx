            ...
            <div className="max-w-sm rounded overflow-hidden shadow-lg">
                <div className="px-6 py-4">
                    ...
                    <div className="px-0 pt-0 pb-0">
                        <span className="inline-block bg-gray-200 rounded-full px-0 py-0 text-l font-semibold text-gray-700 mr-2 mb-2">Owner Name :</span>
                        <span className="inline-block bg-gray-200 rounded-full px-0 py-0 text-sm font-semibold text-gray-700 mr-2 mb-2">{item.owner.Name}</span>
                    </div>
                    <div className="px-0 pt-0 pb-0">
                        ...
                        <span className="inline-block bg-gray-200 rounded-full px-0 py-0 text-sm font-semibold text-gray-700 mr-2 mb-2">{item.owner.number}</span>
                    </div>
